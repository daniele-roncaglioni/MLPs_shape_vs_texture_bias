...
IMG_SIZE = 224
ADAIN_RAW_PAINTINGS_DIR = "../data/paintings_raw/"
ADAIN_EXCLUDED_PAINTINGS_DIR = "../data/paintings_excluded/"
ADAIN_PREPROCESSED_PAINTINGS_DIR = "../data/paintings_preprocessed/"
